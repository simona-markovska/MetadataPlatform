...
This server exposes controlled metadata tools to VS Code Copilot / MCP clients.
...
IMPORTANT:
    ...
    It intentionally does not expose arbitrary SQL execution.
"""
...
def get_connection_string() -> str:
    ...
    Authentication is interactive because this is intended for
...
def get_connection() -> pyodbc.Connection:
    """
    Open a read-only connection to MetadataRepository.

    The server exposes only SELECT-based tools.
    """
...
def rows_to_dicts(
    ...
    """
    Convert the current cursor result into a list of dictionaries.
    """
...
def execute_query(
    ...
    No INSERT / UPDATE / DELETE / DDL is exposed.
    """
...
def get_report_metadata(
    ...
    return {
        ...
        "summary": {
            "pages": len(pages),
            "visuals": len(visuals),
            "visual_fields": len(fields),
            "visual_filters": len(filters),
        },
    }


# ============================================================================
# TOOL 3 - GET REPORT VISUALS
# ============================================================================
...
def get_report_visuals(
    ...
    This is useful for understanding how the semantic model
...
def get_measure(
    ...
    """
    Return a measure, its DAX expression, semantic model,
    semantic table, and dependency metadata.
    """
...
def get_measure_lineage(
    ...
    Lineage path:
        ...
        Measure
            ->
        Semantic Table / Semantic Column
            ->
        MetadataSemanticColumnSource
            ->
        MetadataColumn
            ->
        MetadataTable
    ...
    This is the primary AI lineage tool.
    """
...
# ============================================================================
# TOOL 8 - FIND REPORTS USING A MEASURE
# ============================================================================
...
def find_reports_using_measure(
    ...
    """
    Find every report visual and visual filter that uses a specific measure.
    ...
    return {
        ...
        "visual_usage_count": len(
            visual_usage
        ),

        "filter_usage_count": len(
            filter_usage
        ),
...
def find_unused_measures(
    ...
    """
    Find measures that are not used by any report visual or
    visual-level filter.

    If model_name is provided, only measures from that semantic
    model are checked.

    Returns:

        total measures
        unused measure count
        unused measures
        summary
    """
    ...
    if model_name:
        ...
        unused_sql = """
            ...
            HAVING
                COUNT(vf.MeasureID) = 0
                AND COUNT(vfilter.MeasureID) = 0
...
# ============================================================================
# TOOL 11 - GET REPOSITORY SUMMARY
# ============================================================================
