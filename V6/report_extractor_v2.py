...
class ReportMetadataExtractor:
    ...
    def _extract_legacy_visual_fields(
        ...
        if not select_items and isinstance(
            raw,
            dict,
        ):
            ...
            if isinstance(
                ...
                single_visual = legacy_config.get(
                    "singleVisual",
                    {}
                )
        ...
        if not source_entities and isinstance(
            raw,
            dict,
        ):
...
def resolve_field_ids(
    ...
    if table_name:
        ...
        semantic_table_id = semantic_table_lookup.get(
            (
                semantic_model_id,
                str(table_name),
            )
    ...
    if table_name and column_name:
        ...
        semantic_column_id = semantic_column_lookup.get(
            (
                semantic_model_id,
                str(table_name),
                str(column_name),
